            ...
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    modernSection("HUD Layout", system: "rectangle.inset.filled") {
                        ...
                        Toggle("Show lean meter", isOn: $settings.hudShowLean).tint(.cyan)
                    ...
                    modernSection("Live Activity", system: "bolt.badge.clock.fill") {
                        Toggle("Show speed / kW on Lock Screen", isOn: $settings.liveActivityEnabled).tint(.cyan)
                        Text("Live Activities need iOS 16.1+ and the widget extension included in this project.")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
